def ph_value_message(ph_value):
    '''(float) -> str
    Return a message about given ph_value. If a ph value is less
...
# a better approach
def ph_value_message(ph_value):
    # assign a message to given ph_value
    if (ph_value < 2):
        result = "RUN"
    elif (ph_value < 5):
        result = "That's pretty acidic, I wouldn't drink it"
...
# both approaches will get 100% on the auto-marker
# but working code != good code.
# Style and efficiency is also important.

# always comment your code

# always assume your code will be used by someone else
# so make it clear and easy to maintain