...
my_dictionary = dict()
#my_dictionary = {} # this is confusing because it looks like an empty set
...
# create our own dictionary maps minion's names to the number of eyes
...
# Stuart watched Olympic games and decided to have 5 eyes
